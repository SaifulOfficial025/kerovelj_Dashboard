...
function AddPromotion() {
  ...
  return (
    <div className="p-4 font-sans max-w-full mx-auto">
      {/* Header */}
      <div className="mb-4">
        {/* Replaced Link with a standard anchor tag for standalone component compatibility */}
      ...
      <div className="bg-white rounded-b-lg shadow-sm">
        <form onSubmit={handleSubmit(onSubmit)} className="p-6">
          ...
          <div className="mb-8">
            ...
            {/* Promotion Period: From Date to Date - Adjusted spacing */}
            <div className="flex flex-wrap items-end gap-2 mt-6"> {/* Changed to flex layout with smaller gap */}
              {/* From Date */}
              <div className="flex-1 min-w-[150px]"> {/* Use flex-1 for responsiveness and min-width */}
              ...
              {/* "to" text - No extra padding/margin */}
              <div className="text-gray-700 mb-2"> {/* Added mb-2 to align with label bottom */}
                to
              </div>
              {/* To Date */}
              <div className="flex-1 min-w-[150px]"> {/* Use flex-1 for responsiveness and min-width */}
          ...
          <div className="mb-8">
            <h2 className="text-lg font-medium text-gray-700 mb-4"></h2> {/* No title in image */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Product Name */}
              <div>
